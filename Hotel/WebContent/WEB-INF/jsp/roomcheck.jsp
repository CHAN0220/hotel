...
<div class="container">
  ...
  <form id="form1" name="form1" method="post" action="selectRoomByInfo2">    
...
<div class="container">
  ...
  <input type="submit" style="cursor: pointer;width: 250px;text-align: center;height: 40px;line-height: 40px;background-color: dodgerblue;border-radius: 5px;margin: 0 auto;margin-top: 0px;color: white;" value="确认入住" />
  <table class="table table-hover">
    ...
    <tbody>
      ...
      <form id="form1" name="form1" method="post" action="ConfirmRoom">
	    <tr style="font-size:15px;">
	      <td><input type="submit" name="choose" value="选择"/></td>
